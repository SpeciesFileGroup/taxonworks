...
class Catalog::Nomenclature < Catalog
  class Entry < ::Catalog::Entry
    ...
    def ordered_by_nomenclature_date
      now = Time.now
      items.sort{|a,b| [(a.cached_nomenclature_date&.to_time || now), a.year_suffix.to_s + 'z', a.pages.to_s + 'z', a.object_class, a.base_object.cached_original_combination.to_s ] <=> [(b.cached_nomenclature_date&.to_time || now), b.year_suffix.to_s + 'z', b.pages.to_s + 'z', b.object_class, b.base_object.cached_original_combination.to_s ] }
    end
