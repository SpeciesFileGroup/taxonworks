class TweakPoints3 < ActiveRecord::Migration
  def change
    remove_columns :geographic_items, :point,
                   ...
                   :multi_polygon,
                   :geometry_collection
    add_column :geographic_items, :point, :point, :geographic => true, :has_z => true, :has_m => false
    add_column :geographic_items, :line_string, :line_string, :geographic => true, :has_z => true, :has_m => false
    add_column :geographic_items, :polygon, :polygon, :geographic => true, :has_z => true, :has_m => false
