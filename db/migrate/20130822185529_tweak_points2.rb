class TweakPoints2 < ActiveRecord::Migration[4.2]
  def change
    remove_columns :geographic_items, :point,
                                      ...
                                      :multi_line_string,
                                      :multi_polygon
    add_column :geographic_items, :point, :st_point, :geographic => true, :has_z => true, :has_m => true
    add_column :geographic_items, :line_string, :line_string, :geographic => true, :has_z => true, :has_m => true
    add_column :geographic_items, :polygon, :st_polygon, :geographic => true, :has_z => true, :has_m => true
