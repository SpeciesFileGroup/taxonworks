<template>
  <div
    v-if="isPublic && otuId"
    class="panel padding-large margin-medium-top"
  >
    ...
    <div>
      ...
      <div class="horizontal-left-content gap-medium margin-medium-top">
        <VBtn
...
const statusClass = computed(() => {
  if (pupalDownload.value) return 'feedback-warning padding-xsmall'
  if (completeDownload.value) {
    if (completeDownload.value.ready) return 'feedback-success padding-xsmall'
    if (completeDownload.value.expired) return 'feedback-danger padding-xsmall'
    return 'feedback-warning padding-xsmall'
  }
  return ''
})
