<template>
    <div class="match-options-panel panel content">
        <div class="flex-row flex-separate middle margin-medium-bottom">
            <h3>Match options</h3>
            <VBtn color="primary" @click="emit('clear-all')">
                Clear all matches
            </VBtn>
        </div>
        ...
        <div class="flex-col gap-medium">
            <div class="field margin-medium-bottom">
                ...
                >
                    <span class="subtle"
                        >Scoped to ID: {{ scopeTaxonNameId }}</span
                    >
            ...
            <div class="field">
                ...
                >
                    ...
                    <input
                        ...
                        "
                    />
                    <VBtn circle color="primary" @click="removeModifier(index)">
                        <VIcon x-small name="trash" />
                    </VBtn>
                </div>

                <div class="flex-row gap-small margin-small-top">
                    <VBtn color="primary" medium @click="addModifier">
                        Add row
                    </VBtn>
                    <select
                        class="normal-input"
