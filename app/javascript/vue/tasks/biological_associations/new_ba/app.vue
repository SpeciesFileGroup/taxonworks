<template>
  <div class="margin-medium-top">
    ...
    <div class="grid-panels gap-medium margin-medium-bottom">
      <PanelAnatomicalPart
        v-model="store.subjectAnatomicalPart"
        :parent-object="store.subject"
        title="Subject"
        style="flex: 1"
      />
      <div style="flex: 1"></div>
      <PanelAnatomicalPart
        v-model="store.objectAnatomicalPart"
        :parent-object="store.object"
        title="Related"
        style="flex: 1"
      />
    </div>
...
import PanelAnatomicalPart from './components/Panel/PanelAnatomicalPart.vue'
import PanelShape from './components/Panel/PanelShape.vue'
