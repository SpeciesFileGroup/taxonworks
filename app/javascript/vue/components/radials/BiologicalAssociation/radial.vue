<template>
  <div>
    <div class="radial-annotator">
      ...
      >
        <template #header>
          <h3>Radial biological association</h3>
        </template>
        <template #body>
      ...
      <VBtn
        class="circle-button"
        title="Radial biological association"
        circle
        color="radial"
...
import RotateSlice from './components/RotateSlice.vue'
import RelationshipSlice from './components/RelationshipSlice.vue'
...
const SLICES = {
  Rotate: RotateSlice,
  'Change relationship': RelationshipSlice
}
...
const params = computed(() => {
  const parameters = removeEmptyProperties({
    ...props.parameters,
    biological_association_id: props.ids
  })
...
<script>
export default {
  name: 'RadialBiologicalAssociation'
}
</script>
