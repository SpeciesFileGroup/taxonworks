          ...
          <div class="flex-separate">
            ...
            <form class="horizontal-center-content">
              <transition name="fade">
                <span data-icon="warning" title="You have unsaved changes." class="medium-icon separate-right" v-if="unsavedChanges"/>
              </transition>
              <pin-object v-if="taxon.id" :pin-object="taxon['pinboard_item']" :object-id="taxon.id" :type="taxon.type"/>
              <save-taxon-name v-if="taxon.id" class="normal-input button button-submit"/>
              <create-new-button />
            </form>
          </div>
        </div>
