<template>
  <div v-if="items.length" class="slide-panel-category">
    ...
    <ul class="slide-panel-category-content">
      <li v-for="item in items" class="flex-separate middle slide-panel-category-item"><span v-html="item.citation_object_tag"/><div class="circle-button btn-delete" @click="removeCitation(item)"/></li>
    </ul>
  </div>
</template>
<script>
