  ...
  <div class="panel loan-box">
    ...
    <div class="body horizontal-left-content align-start" v-if="displayBody">
      ...
      <div class="column-right">
        ...
        <hr>
        <label>People</label>
        <role-picker v-model="rolesRecipient" role-type="LoanRecipient"/>
        <div class="horizontal-left-content">
          <div class="separate-right">
            ...
            <div class="field">
              <label>Address</label>
              <textarea v-model="loan.recipient_address" type="text"/>
            </div>
          </div>
        ...
        <p><b>Supervisor</b></p>
        <hr>
        <role-picker v-model="rolesSupervisor" role-type="LoanSupervisor"/>
        <div class="field">
          <label>Email</label>
