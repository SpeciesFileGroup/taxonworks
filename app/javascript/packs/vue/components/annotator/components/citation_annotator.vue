<template>
	<div class="citation_annotator">
		...
		<div v-else>
			<span v-if="citation.hasOwnProperty('id')" v-html="citation.object_tag"></span>
		    ...
		    <display-list :label="['topic', 'object_tag']" :list="citation.citation_topics" @delete="deleteTopic" class="list"></display-list>
		</div>
	</div>
</template>
<script>
