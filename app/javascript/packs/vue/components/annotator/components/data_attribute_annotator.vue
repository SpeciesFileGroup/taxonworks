<template>
	<div class="data_attribute_annotator">
		...
		<table-list :list="list" :header="['Name', 'Value', 'Type', 'Options']" :attributes="['predicate_name', 'value', 'type']" :edit="true"  @edit="data_attribute = $event" @delete="removeItem"></table-list>
	</div>
</template>
<script>
