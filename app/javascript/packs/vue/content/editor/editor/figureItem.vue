<template>
  <div class="figures-container" :class="{ 'card-handle' : !edit }">
    <div class="figures-header">
      ...
      <div class="button-delete circle-button figures-delete" @click="deleteDepiction()"/>
      <div :class="{ 'button-submit' : edit, 'button-default' : !edit }" class="circle-button figures-edit" @click="editChange()"/>
    ...
    <div class="figures-body">
      <textarea v-model="depiction.caption" v-if="edit"/>
