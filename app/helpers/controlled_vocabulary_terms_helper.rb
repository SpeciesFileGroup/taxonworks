module ControlledVocabularyTermsHelper
  ...
  def controlled_vocabulary_term_link(controlled_vocabulary_term)
    return nil if controlled_vocabulary_term.nil?
    link_to(controlled_vocabulary_term_tag(controlled_vocabulary_term.becomes(ControlledVocabularyTerm)).html_safe, controlled_vocabulary_term.becomes(ControlledVocabularyTerm))
  end
