class TaxonNameRelationship::Iczn::Invalidating::Synonym < TaxonNameRelationship::Iczn::Invalidating
  ...
  def sv_synonym_relationship
    if self.source
      ...
      date2 = self.subject_taxon_name.cached_nomenclature_date.nil? ? self.subject_taxon_name.cached_nomenclature_date.to_time : self.subject_taxon_name.nomenclature_date
      if !!date1 && !!date2
