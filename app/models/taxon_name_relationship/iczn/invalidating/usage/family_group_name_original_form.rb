class TaxonNameRelationship::Iczn::Invalidating::Usage::FamilyGroupNameOriginalForm < TaxonNameRelationship::Iczn::Invalidating::Usage
  NOMEN_URI='http://purl.obolibrary.org/obo/NOMEN_0000133'.freeze
  ...
  def self.assignment_method
    ...
    :iczn_set_as_family_group_name_original_form_of
  end

  def self.inverse_assignment_method
    # aus.misspelling = bus
    :iczn_family_group_name_original_form
  end
