...
#
# The canonical use is within a workflow that includes collecting, labelling, and curating a specimen,
# i.e. the process that brings specimens into a collection.
#
# AccessionCodes are not meant to act as CatalogNumbers; in that sense, they annotate a process that
# happens prior to a CollectionObject receiving a CatalogNumber
#
