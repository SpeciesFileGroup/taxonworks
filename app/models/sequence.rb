...
class Sequence < ActiveRecord::Base
  ...
  SequenceRelationship.descendants.each do |d|
    ...
    has_many relationships, class_name: d.name.to_s, foreign_key: :object_sequence_id
    has_many sequences, class_name: 'Sequence', through: relationships, source: :subject_sequence
