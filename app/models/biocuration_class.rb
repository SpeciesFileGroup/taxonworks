...
# these categorizations are for *organization*, they do not also assert that the collection object itself has
# the biological property "maleness", or "adultness". Biocuration classes do help to answer the question "where might
