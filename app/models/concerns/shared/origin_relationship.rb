...
module Shared::OriginRelationship
  ...
  included do
    ...
    has_many :origin_relationships, as: :old_object, dependent: :destroy, inverse_of: :old_object
    has_many :related_origin_relationships, class_name: 'OriginRelationship', as: :new_object, dependent: :destroy, inverse_of: :new_object
