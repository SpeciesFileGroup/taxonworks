module FieldOccurrence::DwcExtensions
  ...
  def set_georeference_attributes
    ...
    when :verbatim
      ...
      if collecting_event.verbatim_latitude && (a = collecting_event.attribute_updater(:verbatim_latitude))
      ...
      h[:georeferencedDate] = (collecting_event&.attribute_updated(:verbatim_latitude) if verbatim_latitude)
    ...
    when :geographic_area
      ...
      h[:georeferencedDate] = (collecting_event.attribute_updated(:geographic_area_id) if geographic_area_id)
