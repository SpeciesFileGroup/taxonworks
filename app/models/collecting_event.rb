...
=end
  ...
  def sv_georeference_matches_verbatim
    if a = georeferences.where(type: 'Georeference::VerbatimData').first
      ...
      unless (a.latitude.to_f ==  d_lat) && (b.longitude.to_f == d_long)
        soft_validations.add(
          :base,
#          "Verbatim latitude #{d_lat} and/or longitude #{d_long} and point geoference latitude #{a.latitude} and/or longitude #{a.longitude} do not match")
