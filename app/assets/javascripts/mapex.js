...
//    var gzoom = 1;      // default to fairly far out
    ...
    map = initialize_mapex(canvas, myOptions);
...
function initialize_mapex(canvas, options) {
...
//        addClickServicesListeners(event);
//    });
//    //google.maps.event.addListener(map, 'click', function(event, addClickServicesListeners()));
//}           // add_listeners end
//
...
//}
//
//function get_DataX(fcdata) {       //this is the scanner version; no google objects are created
...
//};         //get_Data
//
//function getFeatureX(thisFeature) {
//    getTypeData(thisFeature.geometry);
//}
//
//function getTypeDataX(thisType) {        // this version does not create google objects
//
