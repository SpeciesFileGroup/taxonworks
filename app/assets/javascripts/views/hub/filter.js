...
Object.assign(TW.views.hub.filter, {
  ...
  loadCategoriesIcons: function () {
    const categories = [
      {
        selector: '.data_card div[data-category-collecting="true"]',
    ...
    categories.forEach(({ selector, icon }) => {
      ...
      elements.forEach((el) => el.insertAdjacentHTML('beforeend', icon))
    })
  }
})
