  ...
  initialize_autocomplete: function (form) {
    ...
    autocomplete_input.autocomplete({
      ...
      select: function (event, ui) {    // execute on select event in search text box
        TW.views.topics.topic_picker.insert_existing_topic(form, ui.item.object_id, ui.item.label);
        TW.views.topics.topic_picker.clear_topic_picker(form);
        TW.views.topics.topic_picker.make_topic_list_sortable(form);     // was this inadvertantly lost?
        return false;
      }
