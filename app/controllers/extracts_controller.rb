class ExtractsController < ApplicationController
  ...
  private
    ...
    def extract_params
      params.require(:extract).permit(:quantity_value, :quantity_unit, :quantity_concentration, :verbatim_anatomical_origin, :year_made, :month_made, :day_made, :created_by_id, :updated_by_id, :project_id)
    end
end
