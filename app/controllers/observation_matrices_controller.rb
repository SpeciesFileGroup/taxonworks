class ObservationMatricesController < ApplicationController
  ...
  before_action :set_observation_matrix, only: [:show, :api_show, :edit, :update, :destroy, :nexml, :tnt, :nexus, :otu_contents, :reorder_rows, :reorder_columns, :row_labels, :column_labels]
