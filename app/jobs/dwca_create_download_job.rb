class DwcaCreateDownloadJob < ApplicationJob
  ...
  def perform(download, core_scope: nil, extension_scopes: {biological_associations: nil, media: nil}, predicate_extensions: {}, taxon_works_extensions: {})
    begin
      begin
        d = ::Export::Dwca::Data.new(core_scope:, predicate_extensions:, extension_scopes:, taxon_works_extensions:)
