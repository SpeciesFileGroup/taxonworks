json.extract! biological_relationship, :id, :name, :definition, :inverted_name, :is_transitive, :is_reflexive, :created_by_id, :updated_by_id, :layout, :project_id, :created_at, :updated_at
