...
json.metadata do
  if @project_id.nil?
    ...
    json.set!("Past week: New project sources", ProjectSource.where(created_at: 1.week.ago.., project_id: @project_id))
    json.set!("Past week: New taxon names", TaxonName.where(created_at: 1.week.ago.., project_id: @project_id))
    json.set!("Past week: New collection objects", CollectionObject.where(created_at: 1.week.ago.., project_id: @project_id))
    json.set!("Past week: New collecting events", CollectingEvent.where(created_at: 1.week.ago.., project_id: @project_id))
    json.set!("Past week: New observations", Observation.where(created_at: 1.week.ago.., project_id: @project_id))
    json.set!("Past week: New citations", Citation.where(created_at: 1.week.ago.., project_id: @project_id))
    json.set!("Past week: New images", Image.where(created_at: 1.week.ago.., project_id: @project_id))
    json.set!("Past week: New roles", Role.where(created_at: 1.week.ago.., project_id: @project_id))
  end
