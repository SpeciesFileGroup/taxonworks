...
json.partial! '/shared/data/all/metadata', object: georeference

json.geo_json georeference.to_geo_json_feature # check this

json.has_error_polygon georeference.error_geographic_item.present?
json.inferred_error_radius georeference.error_geographic_item&.radius
