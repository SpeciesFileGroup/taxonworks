...
# curl 'http://localhost:3000/api/v1/collection_objects/3/images?token=FindYourOwnToken&project_id=1'
# wget "http://localhost:3000/api/v1/collection_objects/3/images?token=FindYourOwnToken&project_id=1" -O tmp/test.json
