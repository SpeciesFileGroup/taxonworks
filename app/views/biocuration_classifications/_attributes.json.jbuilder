json.extract! biocuration_classification, :id, :biocuration_class_id, :biological_collection_object_id, :position, :created_by_id, :updated_by_id, :project_id, :created_at, :updated_at
