...
json.subject_object_tag taxon_name_tag(taxon_name_relationship.subject_taxon_name)
json.object_object_tag taxon_name_tag(taxon_name_relationship.object_taxon_name)
