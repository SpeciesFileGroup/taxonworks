    ...
    { :Favret =>
          { :dry => {
              ...
              :slide => {
                  ...
                  :condition_of_labels =>   {1 => 'faded to illegible, crumbling or missing, become detached',
              ...
              :wet => {
                  :conservation_status =>  {1 => 'specimens damaged or desiccated (not completely covered by fluid)',
                                            2 => 'fluid level low or dark',
                                            3 =>'fluid topped off and clear'},
                  :processing_state =>     {1 => 'bulk, unprocessed specimens',
                                            2 => 'mixed field samples in clear alcohol and proper vials',
                                            3 => 'properly sorted and labled'},
                  :container_condition =>  {1 => 'bad stoppers/lids, loose vails/jars; vials  loose on shelf',
