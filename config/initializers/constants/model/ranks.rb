...
RANKS = ( ['NomenclaturalRank'] + ICN + ICZN + ICNB + ICTV).freeze
...
RANKS_LOOKUP = ICN_LOOKUP.invert.merge(ICZN_LOOKUP.invert.merge(ICNB_LOOKUP.invert.merge(ICTV_LOOKUP.invert))).freeze
...
FAMILY_RANK_NAMES =  ( FAMILY_RANK_NAMES_ICZN + FAMILY_RANK_NAMES_ICN + FAMILY_RANK_NAMES_ICNB + FAMILY_RANK_NAMES_ICTV).freeze
...
FAMILY_AND_ABOVE_RANK_NAMES = FAMILY_AND_ABOVE_RANK_NAMES_ICZN + FAMILY_AND_ABOVE_RANK_NAMES_ICN + FAMILY_AND_ABOVE_RANK_NAMES_ICNB + FAMILY_AND_ABOVE_RANK_NAMES_ICTV
...
GENUS_RANK_NAMES = ( GENUS_RANK_NAMES_ICZN + GENUS_RANK_NAMES_ICN + GENUS_RANK_NAMES_ICNB + GENUS_RANK_NAMES_ICTV).freeze
...
SPECIES_RANK_NAMES = ( SPECIES_RANK_NAMES_ICZN + SPECIES_RANK_NAMES_ICN + SPECIES_RANK_NAMES_ICNB + SPECIES_RANK_NAMES_ICTV ).freeze
