...
ICZN_TAXON_NAME_RELATIONSHIP_NAMES = TaxonNameRelationship::Iczn.descendants.collect{|r| r.to_s} 

# Array of all ICN TaxonNameRelationship classes, as Strings 
ICN_TAXON_NAME_RELATIONSHIP_NAMES = TaxonNameRelationship::Icn.descendants.collect{|r| r.to_s} 
