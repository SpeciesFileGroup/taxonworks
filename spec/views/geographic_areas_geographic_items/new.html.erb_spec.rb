...
describe "geographic_areas_geographic_items/new", :type => :view do
  before(:each) do
    assign(:geographic_areas_geographic_item, stub_model(GeographicAreasGeographicItem,
  ...
  it "renders new geographic_areas_geographic_item form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", geographic_areas_geographic_items_path, "post" do
