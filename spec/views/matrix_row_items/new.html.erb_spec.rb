...
RSpec.describe "matrix_row_items/new", type: :view do
  before(:each) do
    assign(:matrix_row_item, MatrixRowItem.new(
      :matrix => nil,
      :type => "",
  ...
  it "renders new matrix_row_item form" do
    render

    assert_select "form[action=?][method=?]", matrix_row_items_path, "post" do
