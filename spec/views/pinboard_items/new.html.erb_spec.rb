...
RSpec.describe "pinboard_items/new", :type => :view do
  before(:each) do
    assign(:pinboard_item, PinboardItem.new(
      :pinned_object => nil,
      :user => nil,
      :project => nil,
      :position => 1,
  ...
  it "renders new pinboard_item form" do
    render

    assert_select "form[action=?][method=?]", pinboard_items_path, "post" do
