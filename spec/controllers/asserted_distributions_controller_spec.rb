  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested asserted_distribution" do
        ...
        expect_any_instance_of(AssertedDistribution).to receive(:update).with({"verbatim_label" => "MyText"})
        put :update, {:id => asserted_distribution.to_param, :asserted_distribution => {"verbatim_label" => "MyText"}}, valid_session
      end
