...
describe Queries::CollectionObjectFilterQuery, type: :model, group: [:geo, :collection_objects, :shared_geo] do
  context 'with properly built collection of objects' do
    ...
    before(:all) {
      # GeoBuild.generate_political_areas_with_collecting_events(1, 1)
    }
    ...
    #
    # let(:big_boxia_string) { '{"type":"Feature", "geometry":{"type":"Polygon", "coordinates":[[[33, 28, 0],
    # [37, 28, 0], [37, 26, 0], [33, 26, 0], [33, 28, 0]]]}}' }
    # let(:m1_string) { '{"type":"Feature", "geometry":{"type":"Polygon", "coordinates":[[[33, 28, 0],
    # [34, 28, 0], [34, 27, 0], [33, 27, 0], [33, 28, 0]]]}}' }
    #
    #
    # after(:all) {
