...
describe Queries::Source::Autocomplete, type: :model do
  ...
  let!(:a2) { AlternateValue::Translation.create!(value: 'Diario de cosas y cosas', language: FactoryBot.create(:valid_language), alternate_value_object: j1, alternate_value_object_attribute: :name) }
