      ...
      use_cases = {
        ...
        "c_e_171 prairie # 1 N 41.87734 W 89.34677 2 VIII"                                                                                                =>
          {"DD1" => {:method => "text, DD1"},
           ...
           "DM3" => {:method => "text, DM3"},
           "DM4" => {:method => "text, DM4"},
           "DM5" => {:piece  => " N 41.87734 W 89.34677 ",
                     :lat    => "N41.87734º",
                     :long   => "W89.34677º",
                     :method => "text, DM5"},
           "DM6" => {:piece  => " 1 N 41.87734 W ",
                     :lat    => "1Nº",
                     :long   => "41.87734Wº",
                     :method => "text, DM6"},
           "DM7" => {:method => "text, DM7"},
        ...
        "  S42°5'18.1\" W88°11'43.3\""                                                                                                                    =>
          {"DD1" => {:method => "text, DD1"},
           "DD2" => {:method => "text, DD2"},
           "DM1" => {:method => "text, DM1"},
           "DM2" => {:piece  => " S42°5'18.1\" W88°11'43.3\"",
                     :lat    => "S42º5'18.1\"",
                     :long   => "W88º11'43.3\"",
                     :method => "text, DM2"},
           "DM3" => {:method => "text, DM3"},
           ...
           "DM6" => {:method => "text, DM6"},
           "DM7" => {:method => "text, DM7"},
           "(;)" => {:piece  => "  S42°5'18.1\" W88°11'43.3\"",
                     :lat    => "  S42°5'18.1\" W88°11'43.3\"",
                     :method => "(;)"},
           "(,)" => {:piece  => "  S42°5'18.1\" W88°11'43.3\"",
                     :lat    => "  S42°5'18.1\" W88°11'43.3\"",
                     :method => "(,)"},
        ...
        "  S42°5.18' W88°11.43'"                                                                                                                          =>
          {"DD1" => {:method => "text, DD1"},
           ...
           "DM6" => {:method => "text, DM6"},
           "DM7" => {:method => "text, DM7"},
           "(;)" => {:piece  => "  S42°5.18' W88°11.43'",
                     :lat    => "  S42°5.18' W88°11.43'",
                     :method => "(;)"},
           "(,)" => {:piece  => "  S42°5.18' W88°11.43'",
                     :lat    => "  S42°5.18' W88°11.43'",
                     :method => "(,)"},
        ...
        "#32, USA, California, Guatay, 35 mi E San Diego, N 32o35'45\" W 116o32'27\" 5 V 2003 D. Dmitriev"                                                =>
          {"DD1" => {:method => "text, DD1"},
           "DD2" => {:method => "text, DD2"},
           "DM1" => {:method => "text, DM1"},
           "DM2" => {:piece  => " N 32o35'45\" W 116o32'27\" ",
                     :lat    => "N32º35'45\"",
                     :long   => "W116º32'27\"",
                     :method => "text, DM2"},
           "DM3" => {:method => "text, DM3"},
