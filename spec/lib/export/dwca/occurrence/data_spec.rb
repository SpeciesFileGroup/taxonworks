...
describe Export::Dwca::Occurrence::Data, type: :model, group: :darwin_core do
  ...
  let(:valid_collecting_event_headers) { %w{georeferenceProtocol georeferencedDate verbatimCoordinates verbatimElevation verbatimLatitude verbatimLocality verbatimLongitude} }
