...
describe Export::Dwca::OccurrenceData, type: :model, group: :darwin_core do
  ...
  specify 'initializing without a scope raises' do
    expect {Export::Dwca::OccurrenceData.new()}.to raise_error ArgumentError
  end

  specify 'initializing with a DwcOccurrence scope succeeds' do
    a = Export::Dwca::OccurrenceData.new(core_scope: scope).core_scope.to_sql
    expect(a.include?('ORDER BY dwc_occurrences.id')).to be_truthy
  end

  context 'when initialized with a scope' do
    let(:data) { Export::Dwca::OccurrenceData.new(core_scope: scope) }

    specify 'initializing with a DwcOccurrence scope succeeds' do
      expect(Export::Dwca::OccurrenceData.new(core_scope: scope)).to be_truthy
    end
    ...
    context 'with some occurrence records created' do
      ...
      specify '#collection_object_ids' do
        d = Export::Dwca::OccurrenceData.new(core_scope: scope).collection_object_ids
      ...
      specify '#collection_objects 1' do
        d = Export::Dwca::OccurrenceData.new(core_scope: scope).collection_objects
      ...
      specify '#collection_objects 1' do
        ...
        d = Export::Dwca::OccurrenceData.new(core_scope: scope.where(dwc_occurrence_object_id: [s1.id, s2.id])).collection_objects
        expect(d.all).to contain_exactly(s1, s2)
      end

      specify '#collecting_events 1' do
        d = Export::Dwca::OccurrenceData.new(core_scope: scope).collecting_events
      ...
      context 'various scopes' do
        specify 'with .where clauses' do
          s = scope.where('id > 1')
          d = Export::Dwca::OccurrenceData.new(core_scope: s)
      ...
      context 'extension_scopes: [:biological_associations]' do
        ...
        specify '#biological_associations_resource_relationship_tmp is a tempfile' do
          s = scope.where('id > 1')
          d = Export::Dwca::OccurrenceData.new(core_scope: s, extension_scopes: { biological_associations:  biological_association_scope  })
      ...
      context 'extension_scopes: [:media]' do
        ...
        specify '#media_tmp is a tempfile' do
          s = scope.where('id > 1')
          d = Export::Dwca::OccurrenceData.new(core_scope: s, extension_scopes: { media: media_scope })
      ...
      context ':predicate_extensions with orphaned collection objects' do
        ...
        specify 'stale DwcOccurrence index does not raise' do
          ...
          a = Export::Dwca::OccurrenceData.new(core_scope: scope, predicate_extensions: {collection_object_predicate_id: predicate_ids, collecting_event_predicate_id: predicate_ids } )
        ...
        specify '#collection_object_attributes_query' do
          ...
          a = Export::Dwca::OccurrenceData.new(core_scope: q, predicate_extensions: {collecting_event_predicate_id: [p1.id] } )
        ...
        specify '#collecting_event_attributes match only referenced collecting events' do
          ...
          a = Export::Dwca::OccurrenceData.new(core_scope: q, predicate_extensions: {collecting_event_predicate_id: [p1.id, p2.id] } )
        ...
        specify '#collection_object_attributes' do
          ...
          a = Export::Dwca::OccurrenceData.new(core_scope: scope, predicate_extensions: {collection_object_predicate_id: predicate_ids } )
        ...
        specify '#collecting_event_attributes' do
          ...
          a = Export::Dwca::OccurrenceData.new(core_scope: scope, predicate_extensions: {collecting_event_predicate_id: predicate_ids } )
      ...
      specify '#dwc_id_order' do
        ...
        d = Export::Dwca::OccurrenceData.new(core_scope: scope, taxonworks_extensions: [:otu_name])
      ...
      context 'taxonworks_extensions for internal attributes' do
        context '#taxonworks_extension_data' do
          ...
          specify 'exports in the correct order (ce attributes)' do
            ...
            d = Export::Dwca::OccurrenceData.new(core_scope: scope, taxonworks_extensions: [:elevation_precision])
          ...
          specify 'exports in the correct order (ce & co attributes)' do
            ...
            d = Export::Dwca::OccurrenceData.new(core_scope: scope, taxonworks_extensions: [:otu_name, :elevation_precision])
          ...
          specify 'collection objects without dwc_occurrences, with (ce & co attributes), with (potentially) interfering AssertedDistribution' do
            ...
            d = Export::Dwca::OccurrenceData.new(
          ...
          specify '#extension_computed_fields_data' do
            ...
            d = Export::Dwca::OccurrenceData.new(core_scope: scope.where(dwc_occurrence_object_id: [s1.id, s3.id, s2.id]), taxonworks_extensions: ::CollectionObject::DwcExtensions::TaxonworksExtensions::EXTENSION_FIELDS)
        ...
        context 'exporting otu_name' do
          let(:d) {Export::Dwca::OccurrenceData.new(core_scope: scope, taxonworks_extensions: [:otu_name])}
        ...
        context 'exporting header with different api column name' do
          let(:d) { Export::Dwca::OccurrenceData.new(core_scope: scope, taxonworks_extensions: [:collection_object_id]) }
        ...
        context 'exporting elevation_precision' do
          let(:d) { Export::Dwca::OccurrenceData.new(core_scope: scope, taxonworks_extensions: [:elevation_precision]) }
        ...
        context 'exporting dwc_occurrence.id' do
          let(:d) { Export::Dwca::OccurrenceData.new(core_scope: scope, taxonworks_extensions: [:dwc_occurrence_id]) }
        ...
        context 'when no extensions are selected' do
          let(:empty_extension) { Export::Dwca::OccurrenceData.new(core_scope: scope, taxonworks_extensions: []) }
