...
#
#     @all_items    = FactoryBot.build(:geographic_item_geometry_collection,
#                                      geometry_collection: ALL_SHAPES.as_binary) # 54
#     @outer_limits = FactoryBot.build(:geographic_item_line_string,
...
#     # so, even though it has an otu, that otu
#     # can't be found
