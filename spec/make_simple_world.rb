def simple_world(user_id = 1, project_id = 1)
  ...
  planet_gat = GeographicAreaType.find_or_create_by(name: 'Planet', creator: user, updater: user)
  gat_parish = GeographicAreaType.find_or_create_by(name: 'Parish', creator: user, updater: user)
  gat_land_mass = GeographicAreaType.find_or_create_by(name: 'Land Mass', creator: user, updater: user)
  ...
  item_a = FactoryBot.create(:geographic_item, multi_polygon: RSPEC_GEO_FACTORY.multi_polygon([shape_a]), creator: user, updater: user)
  item_b = FactoryBot.create(:geographic_item, multi_polygon: RSPEC_GEO_FACTORY.multi_polygon([shape_b]), creator: user, updater: user)
  item_e = FactoryBot.create(:geographic_item, multi_polygon: RSPEC_GEO_FACTORY.multi_polygon([shape_e]), creator: user, updater: user)
  ...
  area_e = FactoryBot.create(:level0_geographic_area,
                             ...
                             iso_3166_a3: nil,
                             iso_3166_a2: nil,
                             parent: earth, creator: user, updater: user)
  ...
  @area_a = FactoryBot.create(:level1_geographic_area,
                              ...
                              iso_3166_a3: nil,
                              iso_3166_a2: nil,
                              parent: area_e, creator: user, updater: user)
  ...
  ce_a = FactoryBot.create(:collecting_event,
                           ...
                           verbatim_label: 'Eh?',
                           geographic_area: @area_a, creator: user, updater: user, project: project)
