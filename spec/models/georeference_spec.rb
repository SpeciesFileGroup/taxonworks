...
describe Georeference, type: :model, group: :geo do
    ...
    context 'geographic_item related' do
      ...
      context 'malformed geographic_items' do
        ...
        specify 'errors which result from badly formed error_geographic_item values' do
          g = Georeference::VerbatimData.new(collecting_event:      collecting_event,
      ...
      specify 'error_radius, when provided, should contain geographic_item' do
        ...
        georeference = Georeference::VerbatimData.new(collecting_event: collecting_event,
                                                      error_radius:     16000)
  ...
  context 'methods' do
    specify '#error_box with error_radius returns a key-stone' do
      ...
      expect(collecting_event.geographic_area.default_geographic_item.save).to be_truthy
      georeference.save
