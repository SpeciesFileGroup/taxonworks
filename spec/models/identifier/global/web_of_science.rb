...
describe Identifier::Global::WebOfScience, type: :model, group: :identifiers do
  let(:id) { Identifier::Global::WebOfScience.new(identifier_object: FactoryBot.create(:valid_source)) }
  let(:id_on_person) { Identifier::Global::WebOfScience.new(identifier_object: FactoryBot.create(:valid_person)) }
