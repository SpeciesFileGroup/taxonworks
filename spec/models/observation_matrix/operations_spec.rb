...
RSpec.describe ObservationMatrix, type: :model, group: :observation_matrix do
  ...
  # row 1
  let!(:o1) { Observation.create!(otu: row_object1, descriptor: descriptor1, character_state: character_state1_1) }  
  let!(:o2) { Observation.create!(otu: row_object1, descriptor: descriptor3, character_state: character_state3_1) }  
  let!(:o3) { Observation.create!(otu: row_object1, descriptor: descriptor4, continuous_value: 20, continuous_unit: 'mm' ) }  
  let!(:o4) { Observation.create!(otu: row_object1, descriptor: descriptor6, sample_min: 1, sample_max: 2, sample_n: 5, sample_units: 'mm') }  

  # row 2
  let!(:o5) { Observation.create!(otu: row_object2, descriptor: descriptor1, character_state: character_state1_2) }  
  let!(:o6) { Observation.create!(otu: row_object2, descriptor: descriptor2, character_state: character_state2_3) }  
  let!(:o7) { Observation.create!(otu: row_object2, descriptor: descriptor3, character_state: character_state3_3) }  
  let!(:o8) { Observation.create!(otu: row_object2, descriptor: descriptor4, continuous_value: 40, continuous_unit: 'mm' ) }  
  let!(:o9) { Observation.create!(otu: row_object2, descriptor: descriptor6, presence: true ) }  
  let!(:o10){ Observation.create!(otu: row_object2, descriptor: descriptor6, sample_min: 1, sample_units: 'cm') }  

  # row 3
  let!(:o11) { Observation.create!(otu: row_object3, descriptor: descriptor1, character_state: character_state1_1) }  
  let!(:o12) { Observation.create!(otu: row_object3, descriptor: descriptor1, character_state: character_state1_2) } 
  let!(:o13) { Observation.create!(otu: row_object3, descriptor: descriptor2, character_state: character_state2_1) }  
  let!(:o14) { Observation.create!(otu: row_object3, descriptor: descriptor3, character_state: character_state3_1) }  
  let!(:o15) { Observation.create!(otu: row_object3, descriptor: descriptor3, character_state: character_state3_2) }  
  let!(:o16) { Observation.create!(otu: row_object3, descriptor: descriptor3, character_state: character_state3_3) }  
  let!(:o17) { Observation.create!(otu: row_object3, descriptor: descriptor4, continuous_value: 1, continuous_unit: 'cm' ) }  
  let!(:o18) { Observation.create!(otu: row_object3, descriptor: descriptor5, presence: false) }  
  let!(:o19) { Observation.create!(otu: row_object3, descriptor: descriptor6, sample_min: 0.1, sample_max: 5.22, sample_units: 'mm') }  
  ...
  let!(:o25) { Observation.create!(collection_object: row_object5, descriptor: descriptor2, character_state: character_state2_2) } 
  let!(:o26) { Observation.create!(collection_object: row_object5, descriptor: descriptor5, presence: false) }  
  let!(:o27) { Observation.create!(collection_object: row_object5, descriptor: descriptor5, presence: true) }  
