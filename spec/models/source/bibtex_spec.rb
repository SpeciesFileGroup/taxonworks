  ...
  context 'instance methods - ' do
    ...
    context 'attributes' do
      ...
      context '#cached_string correctly formats ' do
        ...
        specify 'html' do
          expect(src1.cached_string('html')).to eq('Brauer, A. (1909) <i>Die Süsswasserfauna Deutschlands. Eine Exkursionsfauna bearb. ... und hrsg. von Dr. Brauer.</i> G. Fischer, Available from: https://doi.org/10.5962%2Fbhl.title.1086.')
